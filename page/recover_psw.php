    ...
    if(isset($_POST["recover"])){
        ...
        if(mysqli_num_rows($sql) <= 0){
           ...
           <?php
	        ...
	        $mail->SMTPAuth = true;							
	        $mail->Username = 'samridhirajkarnikar22@gmail.com';				
	        $mail->Password = 'uuwppmupeglstxbg';						
	        $mail->SMTPSecure = 'tls';							
	        $mail->Port	 = 587;
             
            // send by h-hotel email
            $mail->setFrom('samridhirajkarnikar22@gmail.com', 'Password Reset');
            ...
            http://localhost/admin/page/reset_psw.php
            <br><br>
            <p>With regrads,</p>
            <b>Administrator</b>";
